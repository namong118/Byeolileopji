...
import { formatHour24 } from '../utils/time';
...
export function TimelineItem({ event, overrideMessage, last }: TimelineItemProps) {
  ...
  return (
    <View style={styles.row}>
      ...
      <View style={styles.content}>
        <Text style={styles.time}>{formatHour24(event.occurredAt)}</Text>
